...
namespace rczEngine
{
	...
	public:
		...
		StrGameObjectPtr CreateActor(const String&& sceneName, const String&& name = "GameObj", Vector3 position = { 0,0,0 }, Vector3 orientation = { 0,0,0 }, Vector3 scale = { 1,1,1 });
		StrCmpPtr CreateComponent(eComponentID component, WeakGameObjPtr owner);
