...
namespace rczEngine
{
	void GeometryPass::SetRenderingMode(RENDERING_MODE mode)
	{
		...
		m_gfx->CompileAndCreateVertexShader(m_Vshader, L"Shaders/GeometryPass.hlsl");
		...
		m_gfx->CompileAndCreatePixelShader(m_PixelSpecSmooth, L"Shaders/GPassSpecSmooth.hlsl");
		m_gfx->CompileAndCreatePixelShader(m_PixelSpecSmoothAlpha, L"Shaders/GPassSpecSmoothAlpha.hlsl");
	...
	void GeometryPass::RenderPass()
	{
		...
		/////NORMAL MATERIALS
		//m_PixelSpecSmooth.SetThisPixelShader(m_gfx);
		//RacrozRenderer::RenderScene(SceneManager::Pointer()->GetActiveScene().get(), CMP_MODEL_RENDERER, MAT_PBR_SpecSmooth, true);
		...
		RacrozRenderer::RenderScene(SceneManager::Pointer()->GetActiveScene().get(), CMP_MODEL_RENDERER, MAT_PBR_TESS, true);
		...
		/////NORMAL MATERIALS
		//m_PixelSpecSmooth.SetThisPixelShader(m_gfx);
		//RacrozRenderer::RenderScene(SceneManager::Pointer()->GetActiveScene().get(), CMP_SKINNED_MODEL_RENDERER, MAT_PBR_SpecSmooth, true);
