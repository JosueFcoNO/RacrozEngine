...
namespace rczEngine
{
	...
	public:
		...
		static Matrix4 LookAtMatrix(Vector3 eye, Vector3 up, Vector3 target);
		static Matrix4 LookAtMatrixZ(Vector3 eye, Vector3 up, Vector3 target);
		static Matrix4 LookAtMatrixY(Vector3 eye, Vector3 up, Vector3 target);
