...
namespace rczEngine
{
	...
	public:
		...
		float BonesWeights[4] = { 0, 0, 0, 0 };
	};

	class GfxCore;

	///A wrapper for the Primitive Topologies enums
		enum eTOPOLOGY
		{
			TOPO_UNDEFINED = 0,
			TOPO_POINTLIST = 1,
			...
			TOPO_LINESTRIP = 3,
			TOPO_TRIANGLELIST = 4,
			TOPO_TRIANGLESTRIP = 5,
			TOPO_LINELIST_ADJ = 10,
			TOPO_LINESTRIP_ADJ = 11,
			TOPO_TRIANGLELIST_ADJ = 12,
			TOPO_TRIANGLESTRIP_ADJ = 13,
			TOPO_1_CONTROL_POINT_PATCHLIST = 33,
			TOPO_2_CONTROL_POINT_PATCHLIST = 34,
			TOPO_3_CONTROL_POINT_PATCHLIST = 35,
			TOPO_4_CONTROL_POINT_PATCHLIST = 36,
			TOPO_5_CONTROL_POINT_PATCHLIST = 37,
			TOPO_6_CONTROL_POINT_PATCHLIST = 38,
			TOPO_7_CONTROL_POINT_PATCHLIST = 39,
			TOPO_8_CONTROL_POINT_PATCHLIST = 40,
			TOPO_9_CONTROL_POINT_PATCHLIST = 41,
			TOPO_10_CONTROL_POINT_PATCHLIST = 42,
			TOPO_11_CONTROL_POINT_PATCHLIST = 43,
			TOPO_12_CONTROL_POINT_PATCHLIST = 44,
			TOPO_13_CONTROL_POINT_PATCHLIST = 45,
			TOPO_14_CONTROL_POINT_PATCHLIST = 46,
			TOPO_15_CONTROL_POINT_PATCHLIST = 47,
			TOPO_16_CONTROL_POINT_PATCHLIST = 48,
			TOPO_17_CONTROL_POINT_PATCHLIST = 49,
			TOPO_18_CONTROL_POINT_PATCHLIST = 50,
			TOPO_19_CONTROL_POINT_PATCHLIST = 51,
			TOPO_20_CONTROL_POINT_PATCHLIST = 52,
			TOPO_21_CONTROL_POINT_PATCHLIST = 53,
			TOPO_22_CONTROL_POINT_PATCHLIST = 54,
			TOPO_23_CONTROL_POINT_PATCHLIST = 55,
			TOPO_24_CONTROL_POINT_PATCHLIST = 56,
			TOPO_25_CONTROL_POINT_PATCHLIST = 57,
			TOPO_26_CONTROL_POINT_PATCHLIST = 58,
			TOPO_27_CONTROL_POINT_PATCHLIST = 59,
			TOPO_28_CONTROL_POINT_PATCHLIST = 60,
			TOPO_29_CONTROL_POINT_PATCHLIST = 61,
			TOPO_30_CONTROL_POINT_PATCHLIST = 62,
			TOPO_31_CONTROL_POINT_PATCHLIST = 63,
			TOPO_32_CONTROL_POINT_PATCHLIST = 64,
		};
		...
		enum eCPU_ACCESS_FLAGS
		{
			CPU_WRITE = D3D11_CPU_ACCESS_WRITE,
			CPU_READ = D3D11_CPU_ACCESS_READ,
			CPU_DEFAULT = 0
		};
